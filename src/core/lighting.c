...
void calculate_lighting_projection(lighting *l, int step)
{
	if (step == 0)
	{
		calculate_camera(l->cam, l->cam->nearPlane, l->cascade0range, 0);
	}
	else if (step == 1)
	{
		calculate_camera(l->cam, l->cascade0range, l->cascade1range, 0);
	}
	else if (step == 2)
	{
		calculate_camera(l->cam, l->cascade1range, l->cascade2range, 0);
	}
	else if (step == 3)
	{
		calculate_camera(l->cam, l->cascade2range, l->cascade3range, 0);
	}
